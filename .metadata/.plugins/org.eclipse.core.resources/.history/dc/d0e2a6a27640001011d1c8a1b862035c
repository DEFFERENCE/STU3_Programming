...
uint8_t modbus_write_servo_up(ModbusHandleTypedef *hmodbus, uint8_t Servo_PWM); //Optional
uint8_t  modbus_write_servo_down(ModbusHandleTypedef *hmodbus, uint8_t Servo_PWM); //Optional
