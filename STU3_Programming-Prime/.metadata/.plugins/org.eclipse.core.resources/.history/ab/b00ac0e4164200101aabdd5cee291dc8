...
//					+ Rev_backlash.backlash_offset;
//			Backlash_Update(&Rev_backlash, pos, p2, v2);
...
//		if (count < 10) {
//			PrismaticTenPoints[count] = ((int) (Encoder_GetPosition_mm(
//					&encoder1)) * 10) / 10.0f;
//			RevoluteTenPoints[count] = ((int) Encoder_GetDegree(&encoder2) * 10)
//					/ 10.0f;
//			count += 1;
//		}
//	}
